...
//                }
        ...
        callback: function (editor, $w, url, state) {
            ...
            if (state == "SUCCESS") {
                //显示图片计数+1
                Upload.showCount++;
                var $img = $("<img src='" + (Base.checkURL(url)?url:(editor.options.imagePath + url)) + "' class='edui-image-pic' />"),
    ...
    var Upload = {
        ...
        uploadComplete: function(link){
            var me = this;
            try{
				Base.callback(me.editor, me.dialog, link, "SUCCESS");
            }catch (e){
